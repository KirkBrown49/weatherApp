...
//  weatherApp
//
//  Created by Kirk Brown on 11/19/18.
...
class GeocodingData {
    ...
    init(formattedAddress: String, latitude: Double, longitute: Double){
    ...
    convenience init?(json: JSON) {
        ...
        self.init(formattedAddress: formattedAddress, latitude: latitude, longitute: longitude)
    }
}
